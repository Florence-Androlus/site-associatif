...
class ResettingController extends AbstractController
{
     ...
     */
    public function request(Request $request, ContactNotification $notification, TokenGeneratorInterface $tokenGenerator)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if (!$user) {
                $this->addFlash('success', "Cet email n'existe pas.");
